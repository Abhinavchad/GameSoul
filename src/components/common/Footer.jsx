      ...
      <div className='footer-top'>
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            ...
            <p className='para-text'>Dive into a vast collection of game titles, discover detailed information about your favorite releases, and explore new ones across various genres..</p>
          </div>

          <div className='footer-item'>
            <h5 className='footer-item-title text-uppercase'>quick link</h5>
          ...
          <div className='footer-item'>
            ...
            <p className='para-text'>Subscribe our newsletter to get our latest update & newsconsectetur</p>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <ul className='footer-bottom-links d-flex justify-content-center'>
            ...
            <li><a href = "/" className='text-white'>Terms & Coditions</a></li>
          </ul>
        </div>
      </div>
    </FooterWrapper>
